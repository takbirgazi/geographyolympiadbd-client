...
import PrevSurveyInfo from "./PrevSurveyInfo/PrevSurveyInfo";

const BlogPrevSurvey = () => {
    const bannerInfo = {
        bgImg: blogBanner,
        optioanTextColor: "text-yellow-500",
        headingColor: "text-[#6f2f9f]",
        specialColorTextColor: "text-blue-500",
        optioanText: "",
        beforeText: "Blog:",
        specialColorText: "Previous Survey Results",
